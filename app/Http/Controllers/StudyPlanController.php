...
class StudyPlanController extends Controller
{
    ...
    public function store(StoreStudyPlanRequest $request)
    {
        ...
        // الـ task_ids اتأكدنا خلاص في الـ Request إنها بتاعت المستخدم ده،
        // فهنا بس بنجيب التاسكات الكاملة بياناتها من الداتابيز
    ...
    {
        $plan = $request->user()->studyPlans()->latest()->first();
...
{
    $plans = $request->user()->studyPlans()->latest()->get();
